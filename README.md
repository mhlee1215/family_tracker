...
![Build 062](https://img.shields.io/badge/build-062-0066cc)
...
- **Shared daily context** (Baby, Task, and Meal views stay on the same selected day)
...
- Adds a 7-day pattern view with 24-hour activity lanes and interval insight cards
