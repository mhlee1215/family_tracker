...
function closeFloatingSectionPanels(target) {
  const babyPanel = state.babyPanel === 'settings' ? elements.babySettingsPanel : state.babyPanel === 'summary' ? elements.growthSummary : state.babyPanel === 'actionLog' ? elements.babyActionLogPanel : null;
  const babyToggle = state.babyPanel === 'settings' ? elements.openBabySettings : state.babyPanel === 'summary' ? elements.openBabySummary : state.babyPanel === 'actionLog' ? elements.openBabyActionLog : null;
...
function setBabyPanel(panel) {
  state.babyPanel = panel === 'summary' || panel === 'settings' || panel === 'actionLog' ? panel : null;
  renderBabyPanel();
}
...
function renderBabyPanel() {
  ...
  elements.openBabyLog?.classList.toggle('active', !summaryOpen && !settingsOpen && !actionLogOpen);
