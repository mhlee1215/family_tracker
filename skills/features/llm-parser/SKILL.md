...
- Deterministic domain logic fills missing values and resolves clear `relativeTime` offsets against recent events.
...
## Checklist
- Verify parser output schema compatibility, including `relativeTime` when relative timestamps are involved.
